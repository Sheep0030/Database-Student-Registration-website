...
<div class="container" id="container">
    <div class="form-container sign-in-container">
        <form  method = "POST" action="STU_login_Error.php">
            <h2>Welcome to<br/>Pong University</h2>
            <br/>
            <span>Student Login</span>
            <input type="text" id="studentUsername" name = "username" minlength = 10 maxlength = 10 pattern="[A-Za-z0-9]+" placeholder="Student ID" />
